...
/**
 * This is the model class for table "beta".
 *
...
class Beta extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('betaName', 'required'),
			array('betaName', 'length', 'max'=>50),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('betaId, betaName', 'safe', 'on'=>'search'),
		);
	}
	...
	public function search()
	{
		...
		$criteria->compare('betaId',$this->betaId);
		$criteria->compare('betaName',$this->betaName,true);
	 ...
	 * @return Beta the static model class
	 */
