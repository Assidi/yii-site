...
class Questions extends CActiveRecord
{
    ...
    /**
     * Перед сохранением переводит ответ в нижний регистр
     */
     protected function beforeSave() {
        if(parent::beforeSave()) {
            $this->answer =  mb_strtolower($this->answer, 'UTF-8');          
         return true;
        }
        else 
            return false;                
    ...
    /**
     * @return array случайный вопрос и ответ 
     * ответ заносится в переменную сессии
     */
    ...
    public static function randomQuestion() {
        ...
        $questRand = array();
        $questRand['question'] = $q->question;
        $questRand['answer'] = $q->answer;
