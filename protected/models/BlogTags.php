...
class BlogTags extends CActiveRecord
{
	...
	public function relations()
	{
		...
		return array(
			'tagsPosts' => array(self::HAS_MANY, 'TagsPosts', 'tagId'),
		);
	}
    ...
    /**
	 * Получение тэгов для показа в выпадающем списке
	 * @return type
	 */
	public static function getList()
	{
		...
		foreach ($models as $model) {
			$arList[$model->tagId] = $model->tagName;
		}
		return $arList;
	}
}
